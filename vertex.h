...
/**
 * @brief Gets the index of a given vertex in the vertex array of the graph.
 *
 * @param Vertex pointer
 *
 * @return Returns the index of a given vertex, or ERROR_VERTEX in 
 * case of error.
 */
...
/**
 * @brief Sets the index of a given vertex in the vertex array of the graph.
 *
 * @param Vertex pointer
 *
 * @return Returns OK or ERROR in case of error.
 */
 Status vertex_setIndex (const Vertex * v, const int index);
